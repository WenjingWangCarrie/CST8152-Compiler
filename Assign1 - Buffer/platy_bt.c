...
* Purpose: To take parameters from the command line: an input file name and a character specifying the buffer
*          operational mode.
*
* Function list: err_printf, display, get_filesize, main
*/
...
/*
* Purpose: This function display the information of buffer in memory.
* Author: Svillen Ranev
* Versions: 1.17.2 2017-09-29
* Called Functions: err_printf(), exit(), fopen(), printf(), b_load(), 
                    fclose(), get_filesize(), display(), b_compact(), 
					b_free()
* Parameters: int argc, char **argv
* Return value: 0
* Algorithm: 1. check use entered file name and mode parameter 
             2. input and load source file
             3. display information of the buffer
*/
...
* Author: Svillen Ranev
* Versions: 1.17.2 2017-09-29
* Called Functions: vfprintf(), fprintf()
* Parameters: char *fmt, ...
* Return value: nothing
* Algorithm: 1. print the error message
*/
void err_printf(char *fmt, ...) {
...
/*
* Purpose: display the information of buffer
* Author: Svillen Ranev
* Versions: 1.17.2 2017-09-29
* Called Functions: printf(), b_rewind(), b_print()
* Parameters: Buffer *ptr_Buffer
* Return value: nothing
* Algorithm: 1. print the buffer message
*/
void display(Buffer *ptr_Buffer) {
...
/*
* Purpose: The function to get the file size
* Author: Svillen Ranev
* Versions: 1.17.2 2017-09-29
* Called Functions: err_printf(), fseek(), fclose()
* Parameters: Buffer *ptr_Buffer
* Return value: flength
* Algorithm: 1. get the file size
*/
long get_filesize(char  *fname) {
	FILE *input;
	long flength;
